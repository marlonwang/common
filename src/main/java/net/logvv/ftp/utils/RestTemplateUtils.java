...
import net.logvv.ftp.common.exception.RestInvocationException;
...
public final class RestTemplateUtils
{
    ...
    public static <T> T doXmlPost(String restPath, Object requestParam, Class<T> responseType,
    		Map<String, String> uriVariables) 
    		throws RestInvocationException
    {
        try
        {
           return restTemplate.postForObject(restPath, requestParam, responseType, uriVariables);
        }
        catch (Exception e)
        {
            throw new RestInvocationException("Failed to invoke rest: " + restPath, e);
	    ...
	    throws RestInvocationException
	{
	    ...
	    StringBuffer urlTemplate = new StringBuffer(DEFAULT_STRINGBUFFER_LENGTH);
